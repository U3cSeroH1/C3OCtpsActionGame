...
public class ItemSpawner : MonoBehaviour
{
    ...
    public void Spawn()
    {
        ...
        if (SpawnPoint)
        {
            Instantiate(items[Succecer].DispgameObject, SpawnPoint.transform.position, Quaternion.identity);

        }
        else
        {
            Instantiate(items[Succecer].DispgameObject, this.transform.position, Quaternion.identity);
