...
public class ItemPlaceArea : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.transform.parent.gameObject.GetComponent<ItemComponent>())
        {

            PlacedItemasGameobj.Add(other.transform.parent.gameObject);
            PlacedItem.Add(other.transform.parent.gameObject.GetComponent<ItemComponent>().ItemType);
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.transform.parent.gameObject.GetComponent<ItemComponent>())
        {
            ...
            PlacedItem.Remove(other.transform.parent.gameObject.GetComponent<ItemComponent>().ItemType);
